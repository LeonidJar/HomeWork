...
# def rhyme_check(characteristic, object: str):
#     new_list = set(map(characteristic, object.split()))
...
# if rhyme_check(lambda x: sum(1 for i in x if i in vowel_list), poem):
#     print('Парам пам-пам')
# else:
#     print('Пам парам')
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    new_list = [[operation(i,j) for i in range(1,num_rows+1)] for j in range(1, num_columns+1)]
